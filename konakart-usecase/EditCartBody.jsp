...
$(function() {	
		...
		for(int k =0; k < 2000000; k++){
			...
			java.util.Vector v = new java.util.Vector(214744444); 
			java.util.Vector v1 = new java.util.Vector(214744444); 
			java.util.Vector v2 = new java.util.Vector(214744444); 
						v2 = new java.util.Vector(214744444); 
						v2 = new java.util.Vector(214744444); 
						v2 = new java.util.Vector(214744444); 
						v2 = new java.util.Vector(214744444); 
						v2 = new java.util.Vector(214744444); 
